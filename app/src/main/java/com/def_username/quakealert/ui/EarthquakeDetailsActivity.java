...
public class EarthquakeDetailsActivity extends AppCompatActivity implements OnMapReadyCallback {
	...
	private String[] getCoordinates() {
		double latitude = Objects.requireNonNull(getIntent().getDoubleArrayExtra("COORDINATES"))[0];
		double longitude = Objects.requireNonNull(getIntent().getDoubleArrayExtra("COORDINATES"))[1];
		double depth = Objects.requireNonNull(getIntent().getDoubleArrayExtra("COORDINATES"))[2];
		if (depth < 0)
			depth *= -1;
